...
def button_held():
    ...
    if counter == 3:
        counter = 0
    print("Button was held. State is now {counter}.")
...
def joystick_held():
    ...
    if counter == 3:
        counter = 0
    # x_value = joystick.x  # Read the X-axis value
    # y_value = joystick.y  # Read the Y-axis value

    # if y_value > JOYSTICK_THRESHOLD:
    #     print("Joystick moved forward.")
    # elif y_value < -JOYSTICK_THRESHOLD:
    #     print("Joystick moved backward.")
    # elif x_value > JOYSTICK_THRESHOLD:
    #     print("Joystick moved right.")
    # elif x_value < -JOYSTICK_THRESHOLD:
    #     print("Joystick moved left.")
    # else:
    #     print("Joystick held, but not in a specific direction.")

    print("Joystick state is {counter}.")
